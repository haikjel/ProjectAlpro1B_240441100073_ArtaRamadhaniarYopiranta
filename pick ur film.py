...
while True:
        ...
        print("3. Tambah Film ke Playlist")
        print("4. Hapus Film dari Playlist")
        print("5. Lihat Info Film")
        print("6. Rekomendasi Film Berdasarkan Genre")
        print("7. Keluar")
